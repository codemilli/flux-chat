...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keymirror = __webpack_require__(127);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _desc, _value, _class; /**
	                            * Created by youngmoon on 3/3/16.
	                            */
	...
	var Firechat = (_class = function () {
	    function Firechat(appId, options) {
	        _classCallCheck(this, Firechat);
	
	        this._firebase = (typeof appId === 'undefined' ? 'undefined' : _typeof(appId)) !== 'object' ? new Firebase(appId || 'https://hckrchat.firebaseio.com/chat') : appId;
	    ...
	    _createClass(Firechat, [{
	        key: 'setUser',
	        value: function setUser(userId, userName, callback) {
	            var _this = this;
	
	            this._firebase.onAuth(function (authData) {
	                if (authData) {
	                    _this._userId = userId.toString();
	                    _this._userName = userName && userName.toString() || 'anonymous';
	                    _this._userRef = _this._firebase.child('users').child(_this._userId);
	                    _this._loadUserMetadata(function () {
	                        setTimeout(function () {
	                            callback(_this._user);
	                            _this._setupDataEvents();
	                        }, 0);
	                    });
	                } else {
	                    _this.warn('Firechat requires an authenticated Firebase reference. ' + 'Pass an authenticated reference before loading.');
	                }
	            });
	        }
	        ...
	        value: function resumeSession() {
	            ...
	            return this._userRef.child('rooms').once('value').then(function (snapshot) {
	                var rooms = snapshot.val();
	
	                for (var roomId in rooms) {
	                    _this2.enterRoom(rooms[roomId].id);
	                }
	        ...
	        key: 'createRoom',
	        value: function createRoom(roomName, roomType) {
	            var _this3 = this;
	            ...
	            return newRoomRef.set(newRoom).then(function () {
	                _this3.enterRoom(newRoom.id);
	        ...
	        value: function enterRoom(roomId) {
	            ...
	            this.getRoom(roomId).then(function (room) {
	                ...
	                if (_this4._rooms[roomId]) {
	                    return;
	                }
	
	                _this4._rooms[roomId] = true;
	
	                if (_this4._user) {
	                    // Save entering this room to resume the session again later.
	                    _this4._userRef.child('rooms').child(roomId).set({
	                        id: roomId,
	                        name: roomName,
	                        active: true
	                    });
	                    ...
	                    var presenceRef = _this4._firebase.child('room-users').child(roomId).child(_this4._userId).child(_this4._sessionId);
	                    _this4._queuePresenceOperation(presenceRef, {
	                        id: _this4._userId,
	                        name: _this4._userName
	                    }, null);
	                }
	
	                // Invoke our callbacks before we start listening for new messages.
	                _this4._onEnterRoom({ id: roomId, name: roomName });
	
	                // Setup message listeners
	                _this4._roomRef.child(roomId).once('value', function (snapshot) {
	                    _this4._messageRef.child(roomId).limitToLast(_this4._options.numMaxMessages).on('child_added', function (snapshot) {
	                        _this4._onNewMessage(roomId, snapshot);
	                    }, function () {
	                        // onCancel
	                        // Turns out we don't have permission to access these messages.
	                        _this4.leaveRoom(roomId);
	                    }, _this4);
	
	                    _this4._messageRef.child(roomId).limitToLast(_this4._options.numMaxMessages).on('child_removed', function (snapshot) {
	                        _this4._onRemoveMessage(roomId, snapshot);
	                    }, function () {}, _this4);
	                }, function () {}, _this4);
	            });
	        }
	        ...
	        key: 'sendMessage',
	        value: function sendMessage(roomId, messageContent, messageType) {
	            var message = {
	                userId: this._userId,
	                name: this._userName,
	            ...
	            var newMessageRef = this._messageRef.child(roomId).push();
	            return newMessageRef.setWithPriority(message, Firebase.ServerValue.TIMESTAMP);
	        }
	    }, {
	        key: 'deleteMessage',
	        value: function deleteMessage(roomId, messageId, cb) {
	        ...
	        key: 'toggleUserMute',
	        value: function toggleUserMute(userId) {
	            if (!this._user) {
	                this._onAuthRequired();
	                if (cb) {
	            ...
	            return this._userRef.child('muted').child(userId).transaction(function (isMuted) {
	        ...
	        key: 'sendSuperuserNotification',
	        value: function sendSuperuserNotification(userId, notificationType, data, cb) {
	        ...
	        key: 'warnUser',
	        value: function warnUser(userId) {
	        ...
	        key: 'suspendUser',
	        value: function suspendUser(userId, timeLengthSeconds, cb) {
	            var _this5 = this;
	
	            var suspendedUntil = new Date().getTime() + 1000 * timeLengthSeconds;
	
	            this._suspensionsRef.child(userId).set(suspendedUntil, function (error) {
	                if (error && cb) {
	                    return cb(error);
	                } else {
	                    _this5.sendSuperuserNotification(userId, 'suspension', {
	        ...
	        key: 'inviteUser',
	        value: function inviteUser(userId, roomId) {
	            var _this6 = this;
	
	            var sendInvite = function sendInvite() {
	                var inviteRef = _this6._firebase.child('users').child(userId).child('invites').push();
	                inviteRef.set({
	                    id: inviteRef.key(),
	                    fromUserId: _this6._userId,
	                    fromUserName: _this6._userName,
	                    roomId: roomId
	                });
	
	                // Handle listen unauth / failure in case we're kicked.
	                inviteRef.on('value', _this6._onFirechatInviteResponse, function () {}, _this6);
	            };
	            ...
	            this.getRoom(roomId).then(function (room) {
	                if (room.type === 'private') {
	                    var authorizedUserRef = _this6._roomRef.child(roomId).child('authorizedUsers');
	        ...
	        key: 'acceptInvite',
	        value: function acceptInvite(inviteId) {
	            var _this7 = this;
	
	            return this._userRef.child('invites').child(inviteId).once('value', function (snapshot) {
	                var invite = snapshot.val();
	
	                if (invite === null) {
	                    throw new Error('acceptInvite(' + inviteId + '): invalid invite id');
	                } else {
	                    _this7.enterRoom(invite.roomId);
	
	                    return _this7._userRef.child('invites').child(inviteId).update({
	                        'status': 'accepted',
	                        'toUserName': _this7._userName
	                    });
	                }
	            }, this);
	        }
	        ...
	        key: 'declineInvite',
	        value: function declineInvite(inviteId) {
	            var updates = {
	                'status': 'declined',
	        ...
	        value: function getRoomList() {
	            return this._roomRef.once('value').then(function (snapshot) {
	                var rooms = snapshot.val() || {};
	
	                return _immutable2.default.fromJS(rooms);
	        ...
	        key: 'getUsersByRoom',
	        value: function getUsersByRoom(roomId, limit) {
	            ...
	            return query.once('value').then(function (snapshot) {
	                ...
	                return Object.keys(usernamesUnique).map(function (name) {
	                    return usernamesUnique[name];
	                });
	            });
	        }
	        ...
	        key: 'getUsersByPrefix',
	        value: function getUsersByPrefix(prefix, startAt, endAt, limit) {
	        ...
	        value: function getRoom(roomId) {
	            return this._roomRef.child(roomId).once('value').then(function (snapshot) {
	                return snapshot.val();
	            });
	        }
	    }, {
	        ...
	        value: function authenticate() {
	            ...
	            return new Promise(function (resolve, reject) {
	                var auth = _this8._firebase.getAuth();
	                if (auth) {
	                    _this8.setUser(auth.uid, auth.github.displayName, function () {
	                        resolve(auth);
	                    });
	                } else {
	                    _this8._firebase.authWithOAuthPopup('github', function (error, auth) {
	                        if (error) {
	                            reject(error);
	                        } else {
	                            _this8.setUser(auth.uid, auth.github.displayName, function () {
	        ...
	        key: '_loadUserMetadata',
	        value: function _loadUserMetadata(onComplete) {
	            var _this9 = this;
	            ...
	            this._userRef.transaction(function (current) {
	                if (!current || !current.id || !current.name) {
	                    return {
	                        id: _this9._userId,
	                        name: _this9._userName
	                    };
	                }
	            }, function (error, committed, snapshot) {
	                if (!error) {
	                    _this9._user = snapshot && snapshot.val();
	                    _this9._moderatorsRef.child(_this9._userId).once('value', function (snapshot) {
	                        _this9._isModerator = !!snapshot.val();
	        ...
	        key: '_setupDataEvents',
	        value: function _setupDataEvents() {
	            var _this10 = this;
	            ...
	            this._firebase.root().child('.info/connected').on('value', function (snapshot) {
	                if (snapshot.val() === true) {
	                    ...
	                    for (var i = 0; i < _this10._presenceBits; i++) {
	                        var op = _this10._presenceBits[i];
	                        var ref = _this10._firebase.root().child(op.ref);
	        ...
	        key: '_addEventCallback',
	        value: function _addEventCallback(eventId, callback) {
	        ...
	        key: '_getEventCallbacks',
	        value: function _getEventCallbacks(eventId) {
	        ...
	        key: '_invokeEventCallbacks',
	        value: function _invokeEventCallbacks(eventId) {
	            var args = [];
	        ...
	        key: '_queuePresenceOperation',
	        value: function _queuePresenceOperation(ref, onlineValue, offlineValue) {
	        ...
	        key: '_removePresenceOperation',
	        value: function _removePresenceOperation(path, value) {
	        ...
	        key: '_onUpdateUser',
	        value: function _onUpdateUser(snapshot) {
	        ...
	        key: '_onAuthRequired',
	        value: function _onAuthRequired() {
	        ...
	        key: '_onEnterRoom',
	        value: function _onEnterRoom(room) {
	            this._invokeEventCallbacks('room-enter', room);
	        }
	    }, {
	        key: '_onNewMessage',
	        value: function _onNewMessage(roomId, snapshot) {
	            var message = snapshot.val();
	            message.id = snapshot.key();
	            this._invokeEventCallbacks('message-add', roomId, message);
	        }
	    }, {
	        key: '_onRemoveMessage',
	        value: function _onRemoveMessage(roomId, snapshot) {
	            var messageId = snapshot.key();
	            this._invokeEventCallbacks('message-remove', roomId, messageId);
	        }
	    }, {
	        key: '_onLeaveRoom',
	        value: function _onLeaveRoom(roomId) {
	        ...
	        key: '_onNotification',
	        value: function _onNotification(snapshot) {
	        ...
	        key: '_onFirechatInvite',
	        value: function _onFirechatInvite(snapshot) {
	            var _this11 = this;
	            ...
	            this.getRoom(invite.roomId).then(function (room) {
	                invite.toRoomName = room.name;
	                _this11._invokeEventCallbacks('room-invite', invite);
	            });
	        }
	    }, {
	        key: '_onFirechatInviteResponse',
	        value: function _onFirechatInviteResponse(snapshot) {
	            var invite = snapshot.val();
	    ...
	    return Firechat;
	}(), (_applyDecoratedDescriptor(_class.prototype, 'createRoom', [requireAuth], Object.getOwnPropertyDescriptor(_class.prototype, 'createRoom'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'enterRoom', [requireAuth], Object.getOwnPropertyDescriptor(_class.prototype, 'enterRoom'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'leaveRoom', [requireAuth], Object.getOwnPropertyDescriptor(_class.prototype, 'leaveRoom'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'sendMessage', [requireAuth], Object.getOwnPropertyDescriptor(_class.prototype, 'sendMessage'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'inviteUser', [requireAuth], Object.getOwnPropertyDescriptor(_class.prototype, 'inviteUser'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'acceptInvite', [requireAuth], Object.getOwnPropertyDescriptor(_class.prototype, 'acceptInvite'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'declineInvite', [requireAuth], Object.getOwnPropertyDescriptor(_class.prototype, 'declineInvite'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'getRoomList', [permitAll], Object.getOwnPropertyDescriptor(_class.prototype, 'getRoomList'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'getUsersByRoom', [permitAll], Object.getOwnPropertyDescriptor(_class.prototype, 'getUsersByRoom'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'getUsersByPrefix', [permitAll], Object.getOwnPropertyDescriptor(_class.prototype, 'getUsersByPrefix'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'getRoom', [permitAll], Object.getOwnPropertyDescriptor(_class.prototype, 'getRoom'), _class.prototype)), _class);
	    ...
	    return _extends({}, descriptor, {
	        value: function value() {
	            ...
	            return this.authenticate().then(function () {
	                return callback.apply(_this12, args);
	            });
	        }
	    });
	}
	
	exports.default = new Firechat();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.Container = __webpack_require__(116);
	module.exports.MapStore = __webpack_require__(117);
	module.exports.Mixin = __webpack_require__(118);
	module.exports.ReduceStore = __webpack_require__(66);
	module.exports.Store = __webpack_require__(67);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _immutable2.default.Record({
	    id: '',
	    message: '',
	    name: '',
	    userId: '',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _firechat = __webpack_require__(24);
	
	var _firechat2 = _interopRequireDefault(_firechat);
	
	var _ChatAppDispatcher = __webpack_require__(22);
	
	var _ChatConstants = __webpack_require__(23);
	
	var _ChatConstants2 = _interopRequireDefault(_ChatConstants);
	...
	var ActionTypes = _ChatConstants2.default.ActionTypes;
	
	var Rooms = _firebase2.default.child('rooms');
	
	var ChatRoomActions = function () {
	    function ChatRoomActions() {
	        _classCallCheck(this, ChatRoomActions);
	    }
	
	    _createClass(ChatRoomActions, [{
	        key: 'getRooms',
	        value: function getRooms(list) {
	            (0, _ChatAppDispatcher.dispatch)({
	        ...
	        key: 'getRoom',
	        value: function getRoom(key, room) {
	            (0, _ChatAppDispatcher.dispatch)({
	        ...
	        key: 'createRoom',
	        value: function createRoom(title) {
	            _firechat2.default.createRoom(title).then(function (newRoom) {
	        ...
	        key: 'clickRoom',
	        value: function clickRoom(roomID, currentRoom) {
	            if (currentRoom) {
	                _firechat2.default.leaveRoom(currentRoom).then(function () {
	                    _firechat2.default.enterRoom(roomID);
	                });
	            }
	            _firechat2.default.enterRoom(roomID);
	        }
	    ...
	    return ChatRoomActions;
	}();
	
	var instance = new ChatRoomActions();
	exports.default = instance;
...
/***/ function(module, exports) {
	...
	var firebase = new Firebase("https://hckrchat.firebaseio.com");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rooms = _firebase2.default.child('rooms');
	var Messages = _firebase2.default.child('messages');
	
	var ChatMessageActions = function () {
	    function ChatMessageActions() {
	        _classCallCheck(this, ChatMessageActions);
	    }
	
	    _createClass(ChatMessageActions, [{
	        key: 'createMessage',
	        value: function createMessage(text, roomID) {
	            _firechat2.default.sendMessage(roomID, text);
	...
	var createMessage = function createMessage(text, roomID) {
	...
	var instance = new ChatMessageActions();
	exports.default = instance;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _immutable2.default.Record({
	    ...
	    title: '',
	    unread: false,
	    messages: _immutable2.default.Map(),
	    lastMessage: new _model2.default()
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChatAppDispatcher2 = _interopRequireDefault(_ChatAppDispatcher);
	...
	var RoomListRecord = _immutable2.default.Record({
	    currentID: undefined,
	    rooms: _immutable2.default.Map()
	});
	
	var RoomInfoStore = function (_ReduceStore) {
	    _inherits(RoomInfoStore, _ReduceStore);
	
	    function RoomInfoStore() {
	        _classCallCheck(this, RoomInfoStore);
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(RoomInfoStore).apply(this, arguments));
	    }
	
	    _createClass(RoomInfoStore, [{
	        key: 'getInitialState',
	        ...
	        value: function reduce(state, action) {
	            switch (action.type) {
	                ...
	                case ActionTypes.GET_ROOM_LIST:
	                    return state.set('rooms', action.list || _immutable2.default.Map());
	        ...
	        value: function getRoomById(id) {
	            return this.getState().get('rooms').get(id) || new _model2.default();
	        }
	    }, {
	        key: 'getCurrentRoom',
	        ...
	        value: function getRooms() {
	            //console.log('rooms', this.getState().get('rooms'));
	            return this.getState().get('rooms');
	        }
	    }, {
	        key: 'getCurrent',
	        value: function getCurrent() {
	            //console.log('current => ', this.getState().get('currentID'));
	...
	var instance = new RoomInfoStore(_ChatAppDispatcher2.default);
	exports.default = instance;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageListItem = function (_React$Component) {
	    ...
	    function MessageListItem(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MessageListItem).call(this, props));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FluxStore = __webpack_require__(67);
	
	var abstractMethod = __webpack_require__(119);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionTypes = _constant2.default.ActionTypes;
	...
	var MessageStore = function (_ReduceStore) {
	    ...
	    function MessageStore() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(MessageStore).apply(this, arguments));
	    }
	    ...
	    _createClass(MessageStore, [{
	        ...
	        value: function reduce(state, action) {
	            switch (action.type) {
	                case ActionTypes.CREATE_MESSAGE:
	                    return state.set(action.roomID, createMessage(state, action));
	        ...
	        key: 'getCurrentRoomMessages',
	        value: function getCurrentRoomMessages(roomID) {
	            return this.getState().get(roomID) || _immutable2.default.List();
	        }
	    }]);
	...
	var addMessage = function addMessage(state, _ref) {
	    ...
	    if (!state.get(roomId)) {
	        state = state.set(roomId, _immutable2.default.List());
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatUserActions = function () {
	    function ChatUserActions() {
	        _classCallCheck(this, ChatUserActions);
	    }
	
	    _createClass(ChatUserActions, [{
	        key: 'setCurrentUser',
	        value: function setCurrentUser(auth) {
	            (0, _ChatAppDispatcher.dispatch)({
	    ...
	    return ChatUserActions;
	}();
	
	var instance = new ChatUserActions();
	exports.default = instance;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageComposer = function (_React$Component) {
	    ...
	    function MessageComposer(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MessageComposer).call(this, props));
	    ...
	    _createClass(MessageComposer, [{
	        ...
	        value: function _onKeyDown(event) {
	            if (event.keyCode === 13) {
	                ...
	                if (text) {
	                    _action2.default.createMessage(text, this.props.currentID);
	                }
	                this.setState({ text: '' });
	            }
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageEmpty = function (_React$Component) {
	  _inherits(MessageEmpty, _React$Component);
	  ...
	  function MessageEmpty(props) {
	    _classCallCheck(this, MessageEmpty);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MessageEmpty).call(this, props));
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          "No Messages, please choose one of the rooms."
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MessageListItem = __webpack_require__(65);
	        ...
	        value: function render() {
	            ...
	            if (messages) {
	                messages.map(function (message) {
	                    return messageList.push(_react2.default.createElement(_MessageListItem2.default, {
	                        key: message.get('id'),
	                        message: message }));
	                });
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RoomListItem = function (_React$Component) {
	    _inherits(RoomListItem, _React$Component);
	    ...
	    function RoomListItem(props) {
	        _classCallCheck(this, RoomListItem);
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(RoomListItem).call(this, props));
	    }
	    ...
	    _createClass(RoomListItem, [{
	        ...
	        value: function render() {
	            ...
	            var date = new Date(room.createdAt);
	            ...
	            return _react2.default.createElement(
	                'li',
	                {
	                    ...
	                    onClick: function onClick() {
	                        return _action2.default.clickRoom(id, current);
	                    } },
	                _react2.default.createElement(
	                    'h5',
	                ...
	                _react2.default.createElement('div', { className: 'thread-last-message' })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RoomInfoSection = __webpack_require__(112);
	
	var _RoomInfoSection2 = _interopRequireDefault(_RoomInfoSection);
	
	var _MessageSection = __webpack_require__(111);
	...
	var _action3 = __webpack_require__(105);
	...
	var ChatApp = function (_React$Component) {
	    ...
	    _createClass(ChatApp, [{
	        ...
	        value: function _onClick() {
	            ...
	            _action2.default.createRoom(title);
	        }
	    }, {
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            _firechat2.default.authenticate().then(function (response) {
	                _action4.default.setCurrentUser(response);
	            });
	        }
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'chatapp' },
	                    _react2.default.createElement(_RoomInfoSection2.default, null),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _store3 = __webpack_require__(104);
	
	var _store4 = _interopRequireDefault(_store3);
	
	var _MessageComposer = __webpack_require__(106);
	
	var _MessageComposer2 = _interopRequireDefault(_MessageComposer);
	
	var _MessageList = __webpack_require__(108);
	...
	var _MessageEmpty = __webpack_require__(107);
	
	var _MessageEmpty2 = _interopRequireDefault(_MessageEmpty);
	...
	var MessageSection = function (_React$Component) {
	    ...
	    _createClass(MessageSection, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            _firechat2.default.on('message-add', function (roomId, message) {
	                //console.log('message-add => ', roomId, message);
	                _action2.default.addMessage(roomId, new _model2.default(message));
	            });
	        }
	        ...
	        value: function render() {
	            ...
	            var currentID = _state.currentID;
	            var messages = _state.messages;
	
	
	            console.log('message => ', currentID, messages);
	
	            return currentID ? _react2.default.createElement(
	                'div',
	                { className: 'message-section' },
	                _react2.default.createElement('h3', { className: 'message-thread-heading' }),
	                _react2.default.createElement(_MessageList2.default, { messages: messages }),
	                _react2.default.createElement(_MessageComposer2.default, { currentID: currentID })
	            ) : _react2.default.createElement(_MessageEmpty2.default, null);
	        }
	    }], [{
	        key: 'getStores',
	        value: function getStores() {
	            return [_store4.default, _store2.default];
	        }
	    }, {
	        key: 'calculateState',
	        value: function calculateState() {
	            return {
	                currentID: _store2.default.getCurrent(),
	                currentRoom: _store2.default.getCurrentRoom(),
	                messages: _store4.default.getCurrentRoomMessages(_store2.default.getCurrent())
	            };
	        }
	    }]);
	...
	var MessageSectionContainer = _utils.Container.create(MessageSection);
	exports.default = MessageSectionContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RoomListItem = __webpack_require__(109);
	...
	var RoomInfoSection = function (_React$Component) {
	    _inherits(RoomInfoSection, _React$Component);
	
	    function RoomInfoSection() {
	        _classCallCheck(this, RoomInfoSection);
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(RoomInfoSection).apply(this, arguments));
	    }
	
	    _createClass(RoomInfoSection, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            _firechat2.default.getRoomList().then(function (roomList) {
	                _action2.default.getRooms(roomList);
	            });
	
	            _firechat2.default.on('room-enter', function (data) {
	                _action2.default.enterRoom(data.id);
	            });
	        }
	        ...
	        value: function render() {
	            ...
	            rooms.mapKeys(function (key) {
	                return roomListItems.push(_react2.default.createElement(_RoomListItem2.default, {
	                    id: key,
	                    key: key,
	                    current: current,
	                    room: rooms.get(key).toJS() }));
	            });
	
	            return _react2.default.createElement(
	                'div',
	                { className: 'thread-section' },
	                _react2.default.createElement('div', { className: 'thread-count' }),
	                _react2.default.createElement(
	                    'ul',
	        ...
	        value: function calculateState() {
	            return {
	                rooms: _store2.default.getRooms(),
	                current: _store2.default.getCurrent()
	            };
	        }
	    }]);
	...
	var RoomInfoSectionContainer = _utils.Container.create(RoomInfoSection);
	exports.default = RoomInfoSectionContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FluxStoreGroup = __webpack_require__(68);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FluxReduceStore = __webpack_require__(66);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fbemitter = {
	  EventEmitter: __webpack_require__(121)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EmitterSubscription = __webpack_require__(122);
	var EventSubscriptionVendor = __webpack_require__(124);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventSubscription = __webpack_require__(123);
